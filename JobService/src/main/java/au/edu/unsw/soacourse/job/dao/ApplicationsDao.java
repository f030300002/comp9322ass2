...
public class ApplicationsDao {
	static public String newApplication(Application app) throws Exception {
	...
	static public String updateApplication(Application app) throws Exception {
	...
	static public List<Application> getApplication(String id) throws Exception {
